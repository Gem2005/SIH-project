      ...
      <div className="py-16 px-4 md:px-8 lg:px-16 xl:px-24 bg-[#e0e5ec] min-h-screen">
        <div className="blog-container mx-auto">
          ...
          <img
            src={blog.imageSrc}
            alt={blog.title}
            className="w-full h-64 object-cover rounded-lg mb-4 shadow-neumorphism"
          />
          ...
          <div className="shadow-neumorphism rounded-lg p-6 mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {blog.tags && blog.tags.map(tag => (
                <span
                  key={tag}
                  className="bg-[#e0e5ec] text-[#4a4a4a] text-xs font-medium py-1 px-3 rounded-lg shadow-neumorphism"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="shadow-neumorphism rounded-lg p-6 mb-6">
            ...
            {blog.comments && blog.comments.map((comment, index) => (
              <div
                key={index}
                className="border-t border-[#c1c8d1] pt-4 last:border-none"
              >

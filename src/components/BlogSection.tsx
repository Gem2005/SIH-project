  ...
  return (
    <section id="blogs" className="py-16 px-4 md:px-8 lg:px-16 xl:px-24 bg-[#e0e5ec]">
      ...
      <div className="mx-auto container">
        <h1 className="text-center text-2xl lg:text-4xl font-bold text-[#4a4a4a] mb-8">Latest from our Blog</h1>
        <div className="mt-8 lg:mt-16 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-6">
          {blogData.latest.map((blog: BlogCardProps, index: number) => (
            <div
              key={index}
            ...
            >
              ...
              <div className="px-4 py-2 rounded-b-lg mt-2">
                ...
                <div className="flex justify-end mt-2">
                  <a href="#" className="text-white bg-gradient-to-r from-[#008AFC] via-blue-500 to-[#1C4483] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-[#008AFC] shadow-lg hover:shadow-[#0056b3] font-medium rounded-lg text-xs px-3 py-1.5 text-center">Read More..</a>
                </div>
              </div>
            </div>
          ))}
